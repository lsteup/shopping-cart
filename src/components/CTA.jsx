...
const CTA = ({ slogan, search, link, image }) => {
  return (
    <div className="bg-gradient-to-l from-orange-100 to-sky-100 flex  justify-between border-2 font-semibold rounded border-zinc-950 mt-4 p-10 items-center gap-6 grow text-center ">
