...
const Deliveries = () => {
  return (
    <div className="text-xs gap-2 sm:text-sm sm:gap-4 border-4 border-zinc-950 flex font-semibold justify-around p-4 my-8 uppercase tracking-tight bg-zinc-50 mx-auto w-4/5">
